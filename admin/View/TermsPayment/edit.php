...
/** @var array $termsPayment */
/** @var int $status */
?>

<?php $controller->view('Components/start'); ?>
<div class="p-4">
    <div class="mb-2"><a href="/admin/terms-of-payment/list"><i class="fa-solid fa-left-long"></i> Назад</a></div>
    ...
    <form action="" method="post">
        <input type="hidden" name="id" value="<?php echo $termsPayment['id']; ?>">
        <div class="mb-4">
            <label for="" class="mb-2">Название</label>
            <input type="text" class="form-control" name="name" value="<?php echo $termsPayment['name']; ?>">
        </div>
        <div class="mb-4">
            <label for="" class="mb-2">Описание</label>
            <textarea name="description" id="description" cols="30" rows="10"><?php echo $termsPayment['description']; ?></textarea>
        </div>
        <div class="mb-4">
            <label for="" class="mb-2">Перевозчик/Клиент</label>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="type-for" id="flexRadioDefault1" value="0"
                    <?php if(! $termsPayment['type_for']) echo 'checked'; ?> >
        ...
        <div class="mb-4">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="type-taxation"  id="flexRadioDefault11" value="С НДС" required
                    <?php if($termsPayment['type_taxation'] == 'С НДС') echo 'checked'; ?> >
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="type-taxation" id="flexRadioDefault12" value="Б/НДС"
                    <?php if($termsPayment['type_taxation'] == 'Б/НДС') echo 'checked'; ?> >
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="type-taxation" id="flexRadioDefault13" value="НАЛ"
                    <?php if($termsPayment['type_taxation'] == 'НАЛ') echo 'checked'; ?> >
