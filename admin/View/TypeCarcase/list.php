...
<div class="p-4">
    <div class="d-flex align-items-center">
        <h4 class="me-2 mb-0">Тип кузова</h4>
    ...
    <button class="btn btn-outline-danger btn-sm mb-4" id="delete" data-name="type-carcase">Удалить выбранные</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" id="form-add" data-name="type-carcase">
...
<div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" id="form-edit-modal" data-name="type-carcase">
