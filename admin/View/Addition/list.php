...
<?php $controller->view('Components/start'); ?>
    <div class="p-4">
        <div class="d-flex align-items-center">
            ...
            <a class="btn btn-sm btn-outline-primary" href="/admin/addition/add" target="_blank">Добавить запись</a>
        </div>
        <p>Всего: <span id="count"></span></p>
        <button class="btn btn-outline-danger btn-sm mb-4" id="delete" data-name="addition">Удалить выбранные</button>
