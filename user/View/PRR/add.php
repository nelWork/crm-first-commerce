...
$controller->view('Components/header');
 $controller->view('PRR/subheader-add-edit');?>
        ...
        <div class="form__body__prr">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="customer_prr" id="customer_prr" class="form-select select-add-application select">
                                ...
                                <?php foreach ($listCustomers as $customer){ ?>
                                    <option value="<?php echo $customer['id']; ?>" <?php if($customer['id'] == 1) echo 'selected';?>>
                ...
                <div class="row form-main__select-cont">
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-5 prr_input_wrap">
                                <select name="prr_id" id="prr_id_input" class="form-select select-add-application  select">
                                    ...
                                    <?php foreach ($listPRRCompany as $PRRCompany){ ?>
                                        <option value="<?php echo $PRRCompany['id']; ?>"><?php echo $PRRCompany['name']; ?></option>
                                    <?php } ?>
                                </select>
                                <script>
                    ...
                    <span>
                        Характер груза <span class="text-danger">*</span>
                            ...
                            <div class="form-floating" style="height: 100%">
                                <textarea class="form-control" placeholder="Характер груза" id="nature_cargo_prr" style="height: 100px"></textarea>
                            </div>
                            <script>
            ...
            <div class="application-special-conditions mt-5 d-flex flex-column gap-5">
                ...
                <div class="form-floating" style="height: 100%">
                    ...
                    <textarea class="form-control" placeholder="Укажите Особые условия" id="special-conditions_prr" style="height: 100%" name="special-conditions"></textarea>
                </div>
                <script>
            ...
            <div class="application-cost my-5 d-flex flex-column gap-5">
                ...
                <div class="application-cost-data row">
                    <div class="col-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="form-floating" style="height: 100%">
                                <textarea class="form-control" placeholder="" id="cost_textarea_prr" style="height: 100%"></textarea>
                                <div class="btn-plus-condition d-none">
                                    ...
                                    <div class="terms-payment_prr-wrap">
                                        <select name="terms-payment_prr" id="select-terms-payment_prr" class="form-select select-chosen united-select" data-placeholder="">
...
<!-- Клиент -->
        <div class="form__body__client">
                    ...
                    <div class="col-3">
                        <div class="mb-3">
                            ...
                            <select name="application_id" id="application_id" class="form-select select-add-application select ">
                                <option value="0" selected>Не привязывать заявку</option>
                                <?php foreach ($listApplication as $application){ ?>
                                    <option value="<?php echo $application["id"]; ?>"
                                         <?php if($application['id'] == $controller->request->input('id-application'))
                                             echo 'selected'; ?>>
                    ...
                    <div class="col-5">
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div>
                                <label for="basic-url" class="form-label">Кол-во грузчиков <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" placeholder="Кол-во грузчиков" class="form-control form-control-solid" name="ref-mode" id="number_loaders-input_client" aria-describedby="basic-addon3 basic-addon4">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="application-special-conditions mt-5 d-flex flex-column gap-5">
                ...
                <div class="form-floating" style="height: 100%">
                    <textarea class="form-control" placeholder="Особые условия" id="special-conditions_client" style="height: 100%" name="special-conditions"></textarea>
                </div>
                <script>
                    ...
                    <div class="col-5">
                        <div class="d-flex flex-column gap-4 ">
                            <div class="">
                                <label for="basic-url" class="form-label">Стоимость, ₽ <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" placeholder="Стоимость" class="form-control form-control-solid" name="cost" id="cost-input_client" aria-describedby="basic-addon3 basic-addon4">
                                </div>
                            </div>
                            <div class="">
                                <label for="basic-url" class="form-label">Вид налогообложения <span class="text-danger">*</span></label>
                            ...
                            <div class="col">
                                <div class="col" id="prr-company_add_inputs">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div id="error-prr-company-inn-isset" class='d-none small mt-2'>ПРР компания с таким ИНН уже есть</div>
                                    </div>
                                    <div class="mb-4">
                                ...
                                <div class="mb-4 d-flex justify-content-between d-flex">
                    ...
                    <form action="" id="form-expenses">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="type_expenses" id="input-type_expenses" placeholder="Вид затрат"
                                   class="form-control form-control-solid mt-2 " value="" required>
                        </div>
                        <div class="mb-2">
    ...
    <script>
        ...
        $('#form-add-prr-company').submit(function (e) {
            ...
            console.log({form_data: form_data, info_inputs: prr_company_info_inputs_values})
    ...
    <script>
        ...
        $('.application_add').on('click', function() {
            ...
            $.ajax({
                url: '/prr/ajax/add-application-prr',
                method: 'POST',
                data: arrayData,
    ...
    <script>
        ...
        $('body').on('click','.custom-dropdown-item', function () {
            $('div').has(this).find('input[name="city"]').val($(this).text());
            $('.custom-dropdown').has($(this)).removeClass('active');
        });
        $('body').on('input','input[name="city"]', function (e) {
            e.stopPropagation();
            $('div').has(this).find('.custom-dropdown').addClass('active');
        });
