...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="list-item__type-document">
        Подписанная заявка от исполнителя (обязательное) (Логист)
    </div>
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file1" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="list-item__type-document">
        Счет от исполнителя (обязательное) (Бухгалтерия)
    </div>
    <div class="list-item__document-rows list-item__document-rows1">
        <div class="list-item__document-row empty">
            <div class="list-item__file-name">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file2" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="list-item__type-document">
        Акт/УПД от исполнителя (обязательное) (Бухгалтерия)
    </div>
    <div class="list-item__document-rows list-item__document-rows1">
        <div class="list-item__document-row empty">
            <div class="list-item__file-name">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file18" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex">
    ...
    <div class="w-100">
        ...
        <input type="text" class="form-control application-comment-document"
               data-id-application="<?php echo $prrApplication->id(); ?>"
               data-side="0"
...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file9" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file10" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file11" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file13" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file14" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto" style="visibility: hidden">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file15" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    <div class="list-item__number">8</div>
    <div class="list-item__type-document">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file19" class="form-upload-file" enctype="multipart/form-data">
...
<div class="quest__table-list-item list-item d-flex position-relative">
    <div class="list-item__number">9</div>
    <div class="list-item__type-document">
        Прочие документы / комментарии
    </div>
    <div class="list-item__document-rows list-item__document-rows1">
    ...
    <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start ml-auto">
        <form action="/prr/application/ajax/uploadFiles" method="post" id="form_file17" class="form-upload-file" enctype="multipart/form-data">
