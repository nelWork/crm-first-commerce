<div class="post-list applications-prr-list <?php if(empty($prrList)) echo 'd-none'; ?>">
                ...
                <script>
    function countPrrApplication(){
        $('#span-quantity-prr-application').text(<?php echo count($prrList); ?>);
    }
    countPrrApplication();
</script>