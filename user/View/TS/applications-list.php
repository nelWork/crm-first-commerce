                    ...
                    <div class="row" style="margin-top: 40px;">
                        <div class="col-8 d-flex">
                            <ul class="nav nav-underline nav-subheader">
                                ...
                                <?php if($isFullCRMAccess OR in_array($controller->auth->user()->id(),[2,17])): ?>
                                    <li class="nav-item">
                                ...
                                <?php if($isFullCRMAccess OR in_array($controller->auth->user()->id(),[4,7])): ?>
                                    <li class="nav-item">
                                        <a href="/ts/list" class="nav-link active">ТС</a>
                                    </li>
                                <?php endif; ?>
                                <li class="nav-item ">
...
<!--                                </li>-->
                        ...
                        <div class="col">
                            <div class="d-flex justify-content-end">
                                <div class="me-3">
                                    <a class="btn btn-theme-white" href="/journal-list?type=ts" target="_blank">
                                        Открыть в журнале
                                    </a>
                                </div>
...
<!--                                </button>-->
            ...
            <div class="wrapper">
                <div class="search search-page-block search-application">
                    <form action="/ts/list?<?php echo $link; ?>" class="d-flex">
                        ...
                        <a class="btn btn-danger btn-cancel" href="/ts/list">Сбросить</a>
                    </form>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 40%">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php $controller->view('TS/application-comment-modal');  ?>
                    </div>
        ...
        <script>
            ...
            $('.js-copy-application').click(function () {
                ...
                $.ajax({
                    url: "/ts/ajax/copy-ts-application",
                    method: "POST",
                    data: {id: id},
                    success: function (response){
                        console.log(response)
                        document.location.href = '/ts/application?id=' + response;
                    }
                });
            })
        </script>
