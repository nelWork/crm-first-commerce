...
$controller->view('TS/subheader-edit');
//dd($additionalProfitList);
//dd($TSApplication);
?>

    <main class="container applications-new__form">
        <div class="form__body__forwarder">
            <input type="hidden" value="<?php echo $TSApplication['id']?>" id="ts_application_id">
            <div class="application-main d-flex flex-column">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" placeholder="Номер входящей заявки" class="form-control form-control-solid"
                                       ...
                                       value="<?php echo $TSApplication['application_number_forwarder']; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="date" placeholder="Дата заявки" class="form-control form-control-solid"
                                       name="date" id="date" aria-describedby="basic-addon3 basic-addon4"
                                       value="<?php echo date('Y-m-d',strtotime($TSApplication['date'])); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <select name="id_customer" id="id_customer" class="form-select select-add-application select">
                                ...
                                <?php foreach ($listCustomers as $customer){ ?>
                                    <option value="<?php echo $customer['id']; ?>"
                                        <?php if($customer['id'] == $TSApplication['id_customer']) echo 'selected';?>>
                ...
                <div class="row form-main__select-cont">
                            ...
                            <div class="d-flex gap-5 forwarder_input_wrap">
                                <select name="id_forwarder" id="id_forwarder" class="form-select select-add-application  select">
                                    ...
                                    <?php foreach ($listForwarders as $forwarder){ ?>
                                        <option value="<?php echo $forwarder['id']; ?>"
                                            <?php if($forwarder["id"] == $TSApplication['id_forwarder']) echo 'selected';?>>
                                            <?php echo $forwarder['name'] .' ' .$forwarder['inn']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                                <script>
                    ...
                    <div class="col-2 d-flex align-items-end mb-3">
                        <button class="btn btn-add-light d-none" data-bs-toggle="modal" data-bs-target="#modalForwarderEdit" id="modal_forwarder_edit">
                            Редактировать
                        </button>
                    </div>
                </div>
                    ...
                    <span>
                        Характер груза <span class="text-danger">*</span>
                            ...
                            <div class="form-floating" style="height: 100%">
                                <textarea class="form-control" placeholder="Характер груза" id="nature_cargo" style="height: 100px">
                                    <?php echo $TSApplication['nature_cargo']; ?>
                                </textarea>
                            </div>
                            <script>
                            ...
                            <div class="">
                                ...
                                <div class="input-group">
                                    <input type="text" placeholder="Мест" class="form-control form-control-solid"
                                           name="place" id="place" aria-describedby="basic-addon3 basic-addon4"
                                           value="<?php echo $TSApplication['place']; ?>">
                                </div>
                            </div>
                            <div class="">
                                ...
                                <div class="input-group">
                                    <input type="text" placeholder="Вес" class="form-control form-control-solid weight-input"
                                           name="weight" id="weight" aria-describedby="basic-addon3 basic-addon4"
                                           value="<?php echo $TSApplication['weight']; ?>">
                                </div>
                            </div>
                            <div class="">
                                <label for="basic-url" class="form-label">Реф режим <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" placeholder="Реф режим" class="form-control form-control-solid"
                                           name="ref_mode-mode" id="ref_mode" aria-describedby="basic-addon3 basic-addon4"
                                           value="<?php echo $TSApplication['ref_mode']; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <select name="id_driver" id="id_driver" class="form-select united-select select  select-add-application">
                                ...
                                <?php foreach ($listDrivers as $driver){ ?>
                                    <option value="<?php echo $driver['id']; ?>"
                                        <?php if($driver["id"] == $TSApplication['id_driver']) echo 'selected';?>
                                    >
...
<!---->
<!--                            <select id="driver_forwarder_transport" class="form-select">-->
<!---->
<!--                            </select>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
                        ...
                        <div class="">
                            ...
                            <div class="input-group input-group-without-choices__inner">
                                <input type="text" placeholder="Марка" class="form-control form-control-solid united-input js-trigger-input-choices"
                                       ...
                                       value="<?php echo $TSApplication['car_brand']; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="input-group">
                                <input type="text" placeholder="Гос номер" class="form-control form-control-solid"
                                       ...
                                       value="<?php echo $TSApplication['government_number']; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="input-group">
                                <input type="text" placeholder="П/П" class="form-control form-control-solid"
                                       ...
                                       value="<?php echo $TSApplication['semitrailer']; ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="">
                            ...
                            <div class="input-group input-group-without-choices__inner">
                                <input type="text" placeholder="Тип транспорта" class="form-control form-control-solid united-input js-trigger-input-choices"
                                       ...
                                       value="<?php echo $TSApplication['type_transport']; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="input-group input-group-without-choices__inner">
                                <input type="text" placeholder="Тип кузова" class="form-control form-control-solid united-input js-trigger-input-choices"
                                       ...
                                       value="<?php echo $TSApplication['type_carcase']; ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="application-special-conditions mt-5 d-flex flex-column gap-5 d-none">
                ...
                <div class="form-floating" style="height: 100%">
                    <textarea class="form-control" placeholder="Leave a comment here" id="special_conditions" style="height: 100%" name="special_conditions">
                        <?php echo $TSApplication['special_conditions']; ?>
                    </textarea>
                </div>
                <script>
            ...
            <div class="application-cost mt-5 d-flex flex-column gap-5">
                ...
                <div class="application-cost-data row">
                    <div class="col-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="form-floating" style="height: 100%">
                                <textarea class="form-control" placeholder="" id="terms_payment" style="height: 100%">
                                    <?php echo $TSApplication['terms_payment']; ?>
                                </textarea>
                            ...
                            <div class="">
                                ...
                                <div class="input-group">
                                    <input type="text" placeholder="Стоимость перевозки" class="form-control form-control-solid"
                                           ...
                                           value="<?php echo $TSApplication['transportation_cost']; ?>">
                                </div>
                            </div>
<!--                            <div class="d-none">-->
...
<!--                                           value="--><?php //echo $TSApplication['cost_cargo']; ?><!--">-->
<!--                                </div>-->
<!--                            </div>-->
                            <div class="">
                                    ...
                                    <select name="taxation_type" id="taxation_type" class="form-select select-type-taxation select">
                                        ...
                                        <?php foreach ($listTypesTaxation as $typeTaxation){ ?>
                                            <option value="<?php echo $typeTaxation["name"]; ?>"
                                                <?php if($typeTaxation["name"] == $TSApplication['taxation_type']) echo 'selected';?>>
                ...
                <div id="expenses-forwarder-block_forwarder" class="w-75 mb-4">
                    <?php $counterAdditionalExpenses = 1; foreach ($additionalExpensesList as $additionalExpense): ?>
                        <div class="expenses-item expenses-item_<?php echo $counterAdditionalExpenses; ?>"
                             ...
                             data-sum="<?php echo $additionalExpense["sum"];?>"
                             data-id="<?php echo $additionalExpense['id']; ?>"
                             data-type-payment="<?php echo $additionalExpense["type_payment"];?>"
                             data-comment="<?php echo $additionalExpense["comment"];?>">
                            <div class="row">
                                <div class="col">
                                    <label for="">Вид затрат</label>
                                    <span class="expense-type-expenses_<?php echo $counterAdditionalExpenses; ?>">
                                        <?php echo $additionalExpense["type_expenses"];?>
                                    </span>
                                </div>
                                <div class="col">
                                    <label for="">Сумма</label>
                                    <span class="expense-sum_<?php echo $counterAdditionalExpenses; ?>">
                                        <?php echo $additionalExpense["sum"];?>
                                    </span>
                                </div>
                                <div class="col">
                                    <label for="">Вид налогообложения</label>
                                    <span class="expense-type-payment_<?php echo $counterAdditionalExpenses; ?>">
                                        <?php echo $additionalExpense["type_payment"];?>
                                    </span>
                                </div>
                                <div class="col">
                                    <label for="">Комментарий</label>
                                    <span class="expense-comment_<?php echo $counterAdditionalExpenses; ?>">
                                        <?php echo $additionalExpense["comment"];?>
                                    </span>
                                </div>
                                <div class="col">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><div class="dropdown-item js-edit-expenses" onclick="editExpense(<?php echo $counterAdditionalExpenses; ?>);">Редактировать</div></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                    <?php $counterAdditionalExpenses++; endforeach; ?>
                </div>
            </div>
            <div class="application-additional-costs mt-5 d-flex flex-column gap-4">
                ...
                <div id="additional_profit-block_forwarder" class="w-75 mb-4">
                </div>
            </div>
        </div>
...
<!--Маска для цифр-->
    <script>
        ...
        document.getElementById('edit-expense-sum').oninput = function (){
            let value = $('#edit-expense-sum').val();
            value = value.replaceAll(' ' ,'');
            // console.log(value);

            $('#edit-expense-sum').val(formatNumber(value));
        }
        ...
        function ajaxGetDriver(driver_id){
            $.ajax({
                ...
                success: function (driver_json){
                    ...
                    //     }
                    //
                    //     $('#driver_forwarder_transport').html(htmlOptionDriverCar);
                    //
...
//Экспедитор
        ...
        ajaxGetForwarder($('#id_forwarder').val());
        ...
        $('#form-edit-forwarder-from-edit').submit(function (e){
            e.preventDefault();
...
//Доп прибыль
        ...
        let html____ = "";
        <?php foreach ($additionalProfitList as $additional_profit){?>
                            ...
                            <div class="col">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><div class="dropdown-item js-edit-additional_profit" onclick="editAdditionalProfit(${additionalProfitIndex});">Редактировать</div></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    </div>`;
        $('#additional_profit-block_forwarder').append(html____);
        <?php }?>
        ...
        $('#form-additional_profit').submit(function (e) {
            ...
            $('#additional_profit-block_forwarder').append(html);
        })
    ...
    <script>
        ...
        function collectAdditionalProfit(){
            ...
            return collectData('#additional_profit-block_forwarder .additional_profit-item', fields);
        }
    ...
    <script>
        ...
        $('.application_add').on('click', function() {
            ...
            let arrayData = {
                ...
                'transportationCost': $('#transportation_cost').val(),
                'taxationType': $('#taxation_type').val(),
                // 'costCargo': $('#cost_cargo').val(),
            ...
            $.ajax({
                url: '/ts/ajax/edit-application-ts',
                method: 'POST',
                data: arrayData,
                success: function (response){
                    console.log(response);
