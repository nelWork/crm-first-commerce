...
//dd($uniqueData);
// dd($listApplication,$listPRRApplication);
//dd($dataPost);
    ...
    <div class="table-container">
        ...
        <?php foreach ($listApplication as $application): ?>
            ...
            <tr class="js-tr-application tr-application
                <?php if($application['strange_application']) echo 'strange-application'; ?>
...
<script>
    ...
    function countAllSum(){
        let arrayNumCol = {12:0, 13:0, 14:0, 15:0, 19:0, 20:0, 21:0, 22:0, 23:0, 24:0, 25:0, 26:0, 28:0};
    ...
    $('#journal-excel').click(function () {
        ...
        $.ajax({
            ...
            data: {
                ...
                <?php if($dataPost != ''): ?>
                    'app-id' : '<?php echo $dataPost; ?>',
                <?php endif; ?>
                 <?php if($dataPrrPost != ''): ?>
                    'prr-app-id' : '<?php echo $dataPrrPost; ?>',
                <?php endif; ?>
            ...
            success: function (response){
                ...
                download_file('<?php if($nameFile == '') echo 'journal'; else echo $nameFile; ?>.xlsx', data['link_file']);
            }
        })
    });

    $('#journal-excel-stat').click(function () {
        let $this = $(this);
        $this.attr('disabled', true);
        let section = $('.js-tab-section.active').data('section');
        let customer = $('.js-tab-customer.active').data('id-customer');
