            ...
            <div class="row" style="margin-top: 40px;">
                <div class="col-6">
                    <ul class="nav nav-underline nav-subheader">
                        <li class="nav-item">
                            <a href="#" class="nav-link active">База клиентов</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="base-clients__list">
        ...
        <div class="wrapper" style="">
            <div class="post-list__header d-flex">
                ...
                <div class="post-list__header-item client">ФИО/ТЕЛЕФОН</div>
               ...
               <!-- <div class="post-list__header-item client">Последний комментарий</div> -->
...
<div class="modal fade" id="addClientModal" tabindex="-1" aria-labelledby="addClientModalLabel" aria-hidden="true">
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addClientModalLabel">Добавление клиента</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Закрыть"></button>
            </div>
            <div class="modal-body">
            </div>
                ...
                <form action="/application/ajax/add-client" method="post" id="form-add-client-from" class="form-add-client">
                    <div class="row">
                        <div class="col" id="client_add_inputs">
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-1">
                                    ...
                                    data-bs-title='Вы можете ввести ИНН и нажать ENTER подтянуться данные по названию и адресу'></i>
                        ...
                        <div class="col">
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-1">Телефон, код в АТИ, конт. лицо <span class="text-danger">*</span></label>
