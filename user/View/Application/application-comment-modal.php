...
<div class="card-application">
    <div class="w-100 comment__add-input d-flex flex-column mb-5" id="comment__add-input" data-id-app="0">
    ...
    <div class="w-100 comment__add-input edit d-none flex-column mb-5"  id="comment__edit-input" data-id-app="0" data-id-comment="0">
        <div class="d-flex w-100 mb-4">
            <img src="<?php echo $controller->auth->user()->avatar(); ?>" alt="" class="avatar">
