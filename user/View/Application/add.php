    ...
    <main class="container applications-new__form">
        ...
        <div class="form__body__carrier">
            ...
            <div class="application-transportation mt-5 d-flex flex-column gap-5">
                ...
                <div class="btn-wrap">
                    <button class="btn btn-add-light" data-bs-toggle="modal"
                            data-bs-target="#modalMarshrut" onclick="$('#form-add-marshrut-side').val('carrier');">Добавить маршрут</button>
                </div>
            ...
            <div class="application-additional-costs d-flex flex-column gap-4">
                ...
                <div id="expenses-carrier-block_carrier" class="w-75 mb-4">
...
<!--                                        <li><div class="dropdown-item js-edit-expenses" onclick="editExpense(1);">Редактировать</div></li>-->
<!--                                    </ul>-->
<!--                                </div>-->
                            </div>
                        </div>
...
<!--                        <div class="mb-2">-->
<!--                            <label for="" class="mb-2">Выберите ПРР компанию <span class="text-danger">*</span></label>-->
<!--                            <select name="id_prr_company" id="select-prr-company-additional-expenses" class="form-select">-->
<!--                                --><?php //foreach ($listPRRCompany as $prr): ?>
<!--                                    <option value="--><?php //echo $prr['id']; ?><!--">-->
<!--                                        --><?php //echo $prr['name']; ?><!-- (--><?php //echo $prr['inn'];?><!--)-->
<!--                                    </option>-->
<!--                                --><?php //endforeach; ?>
<!--                            </select>-->
<!--                        </div>-->
                            ...
                            <div class="col">
                                <div class="col" id="carrier_add_inputs">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" name="carrier_inn" placeholder="ИНН" id="add-carrier-inn" class="form-control form-control-solid" required>
        ...
        $('.application_add').click(function (){
            ...
            $.ajax({
                ...
                success: function (response){
                    ...
                    // else if(data['status'] === 'Error taxation'){
                    //     alert(data['message']);
                    // }
                    else{
                        alert("Не правильно заполнены поля");
            ...
            $.ajax({
                ...
                success: function (response){
                    ...
                    if (data['status'] === "Success"){
                        ...
                        $(".client_input_wrap").html(`<select name="client" id="client_id_input"
                            class="form-select select-add-application select ">
                                <option value="0" disabled selected>Клиент</option>
                                <?php foreach ($listClients as $client){ ?>
                                    <option value="<?php echo $client["id"]; ?>"><?php echo $client['name'] .' ' .$client['inn']; ?></option>
                                <?php } ?>
