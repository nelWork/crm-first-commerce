...
$controller->view('Application/subheader-add-edit');?>
        ...
        <div class="form__header">
            <div class="wrapper">
                ...
                <span href="#" class="form__header-menu-item carrier-tab">
                    ...
                    <!--<button class="btn btn-add-light duplicate" id="duplicate" style="margin-left: auto">-->
                    <!--    Дублировать-->
                    <!--</button>-->
                    ...
                    <!--                </button>-->
                    <!--                <select name="" id="style-select" class="form-select select-add-application" style="width: 150px">-->
                    <!--                    <option value=1 selected>Классика</option>-->
                    <!--                    <option value=0>Свободный</option>-->
                    <!--                </select>-->
                    <!--                <button class="btn btn-add-light" id="application_add" style="margin-left: auto">-->
        ...
        <div class="form__body__carrier">
                ...
                <div class="row type-applications">
                    ...
                    <div class="col-7">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" placeholder="Заголовок" class="form-control form-control-solid" name="main-slogan" id="main-slogan-input_carrier" aria-describedby="basic-addon3 basic-addon4">
                            </div>
                        </div>
                    </div>
                    <!--        <div class="col-2">-->
                    <!--            <div class="mb-3">-->
                    <!--                <label for="basic-url" class="form-label">Дата заявки <span class="text-danger">*</span></label>-->
                    <!--                <div class="input-group">-->
                    <!--                    <input autocomplete="off" type="text" class="form-control" name="date" id="date-input_carrier" aria-describedby="basic-addon3 basic-addon4" placeholder="Дата заявки">-->
                    <!--                </div>-->
                    <!--            </div>-->
                    <!--            <script type="module">-->
                    <!--                new AirDatepicker('#date-input_carrier');-->
                    <!--            </script>-->
                    <!--        </div>-->
                </div>
                    ...
                    <span>
                        Характер груза <span class="text-danger">*</span>
                            ...
                            <div class="form-floating" style="height: 100%">
                                <textarea class="form-control" placeholder="Характер груза" id="nature_cargo_carrier" style="height: 100px"></textarea>
                            </div>
                            <script>
                    ...
                    <div class="col d-flex align-items-end gap-2 justify-content-start">
                        <div class="item-doc-fotmat">
                            <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start">
                                <input class="form-check-input seal" data-name="seal" id="check-show-driver-number" type="checkbox" value="">
            ...
            <div class="application-special-conditions mt-5 d-flex flex-column gap-5">
                ...
                <div class="form-floating" style="height: 100%">
                    ...
                    <textarea class="form-control" placeholder="Leave a comment here" id="special-conditions_carrier" style="height: 100%" name="special-conditions"><p><strong>Особые условия прописаны в следующем листе. За несоблюдение особых условий штраф в размере 50% от стоимости перевозки. <br> Приложение № 1 считать продолжением данной заявки.</strong></p></textarea>
                </div>
                <script>
            ...
            <div class="application-cost mt-5 d-flex flex-column gap-5">
                ...
                <div class="application-cost-data row">
                    <div class="col-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="form-floating" style="height: 100%">
                                <textarea class="form-control" placeholder="" id="cost_textarea_carrier" style="height: 100%"></textarea>
            ...
            <div class="application-special-conditions mt-5 d-flex flex-column gap-5">
                ...
                <div class="form-floating" style="height: 350px">
                    <textarea class="form-control" placeholder="" id="prerequisites" style="height: 100%" name="prerequisites"></textarea>
                    <div class="btn-plus-condition">
                <span class="js-trigger-select-choices">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path opacity="0.3" d="M17 2H7C4.23858 2 2 4.23858 2 7V17C2 19.7614 4.23858 22 7 22H17C19.7614 22 22 19.7614 22 17V7C22 4.23858 19.7614 2 17 2Z" fill="black"></path>
            ...
            <div class="application-addition  d-flex flex-column gap-4">
                <div class="title-base">
                    Приложение
                </div>
                <div class="form-floating mb-5">
                    <!--                <textarea class="form-control" placeholder="Leave a comment here" id="prerequisites" style="height: 100%" name="prerequisites"></textarea>-->
                    <select name="conditions_carrier" id="select-addition" class="form-select select-chosen united-select">
                        <?php foreach ($listAdditions as $addition){ ?>
                            <option value="<?php echo $addition['id']; ?>"><?php echo $addition['name'] ;?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>

            <div class="application-сarrier-fines  d-flex flex-column gap-4">
                <div class="title-base">
        ...
        <div class="form__body__client">
            <div class="application-main d-flex flex-column">
                ...
                <div class="row type-applications">
                    ...
                    <div class="col-2">
                        <div class="mb-3">
                            <label for="basic-url" class="form-label">Номер  доверенности</label>
                            <div class="input-group">
                                <input type="text" class="form-control" name="proxy-number" id="proxy-input" aria-describedby="basic-addon3 basic-addon4" >
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row form-main__select-cont">
                    ...
                    <div class="col d-flex align-items-end mb-3 justify-content-start">
                        <div class="item-doc-fotmat">
                            <div class="form-check form-check-custom form-check-solid form-check-sm align-items-start">
                                <input class="form-check-input seal" id="check-hide-title" type="checkbox">
                                <label for="check-hide-title" style="font-size: 14px;">Скрыть под заголовок</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="application-transportation-data row">
                    ...
                    <span>
                        Характер груза <span class="text-danger">*</span>
                            ...
                            <div class="form-floating" style="height: 100%">
                                <textarea class="form-control" placeholder="" id="nature_cargo_client" style="height: 100px"></textarea>
                            </div>
                        </div>
                        <script>
            ...
            <div class="application-special-conditions mt-5 d-flex flex-column gap-5">
                ...
                <div class="form-floating" style="height: 100%">
                    <textarea class="form-control" placeholder="" id="special-conditions_client" style="height: 100%" name="special-conditions"></textarea>
                </div>
                <script>
                    ...
                    <div class="col-7">
                        <div class="d-flex flex-column gap-3">
                            <div class="form-floating" style="height: 100%">
                                ...
                                <textarea class="form-control" placeholder="" id="cost_textarea_client" style="height: 100%"></textarea>
                                <!--                        <div class="dropdown">-->
                                <!---->
                                <!--                            <button class="btn btn-add-light" type="button" data-bs-toggle="dropdown" aria-expanded="false">+</button>-->
                                <!--                            <div class="dropdown-menu p-4 text-body-secondary">-->
            ...
            <!--            <div class="form-floating" style="height: 350px">-->
            <!--                <textarea class="form-control" placeholder="Leave a comment here" id="prerequisites" style="height: 100%" name="prerequisites"></textarea>-->
            <!--                <select name="" id="select-conditions" class="form-select  ">-->
            <!--                    --><?php //foreach ($listConditions as $condition){ ?>
            <!--                        <option value="--><?php //echo $condition['id'] ?><!--">--><?php //echo $condition['name'] ;?><!--</option>-->
            <!--                    --><?php //} ?>
            <!--                </select>-->
            ...
            <!--            </div>-->
            <!---->
            <!--            <button class="btn btn-primary" id="collect-fines">-->
            <!--                Собрать-->
            <!--            </button>-->
            <!--        </div>-->

            <div class="application-additional-costs mt-5 d-flex flex-column gap-4">
                <div class="title-base">
                    Доп затраты
                </div>
                <div>
                    <button class="btn btn-add-light"
                            data-bs-toggle="modal" data-bs-target="#modalExpenses" onclick="$('#expenses-type-for').val(1);">Доп затраты</button>
                </div>
                <div id="expenses-carrier-block_client" class="w-75">
                </div>
            </div>
        </div>
                    ...
                    <form action="" id="form-add-marshrut">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-4">
                                ...
                                <input type="text" name="loading_method" class="form-control form-control-solid" placeholder="Способ выгрузки" required>
                            </div>
                            <div class="col-6 mb-4">
    ...
    <div class="modal modal-add-application fade" id="modalFinesFrom"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light btn-close-modal" data-bs-dismiss="modal">Отменить</button>
                    <button type="button" class="btn btn-add-light" id="btn-add-fines-from">Добавить</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal modal-add-application fade" id="modalFinesTo"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light btn-close-modal" data-bs-dismiss="modal">Отменить</button>
                    <button type="button" class="btn btn-add-light" id="btn-add-fines-to">Добавить</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal modal-add-application fade" id="modalEditFine"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light btn-close-modal" data-bs-dismiss="modal">Отменить</button>
                    <button type="button" class="btn btn-add-light" id="btn-edit-fines">Сохранить</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <form action="" id="form-expenses">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="type_expenses" placeholder="Вид затрат" class="form-control form-control-solid" required>
                        </div>
                        <div class="mb-2">
                            <label for="" class="mb-1">Сумма <span class="text-danger">*</span></label>
                            <input type="text" name="sum" placeholder="Сумма" class="form-control form-control-solid" required>
    ...
    <div class="modal modal-add-application fade" id="modalCarrier" tabindex="-1" aria-labelledby="modalCarrier" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                            ...
                            <div class="col">
                                <div class="col" id="carrier_add_inputs">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="carrier_info" id="carrier_info-input" placeholder="8 ()--, код в АТИ, Имя:" class="form-control form-control-solid carrier_info-input" required value="8 ()--, код в АТИ ">
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light btn-close-modal" data-bs-dismiss="modal">Отменить</button>
                    <button type="button" class="btn btn-add-light" id="btn-add-carrier-from">Добавить</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal modal-add-application fade" id="modalCarrierEdit" tabindex="-1" aria-labelledby="modalCarrierEdit" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light btn-close-modal" data-bs-dismiss="modal">Отменить</button>
                    <button type="button" class="btn btn-add-light" id="btn-add-carrier-from-edit">Сохранить</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal modal-add-application fade" id="modalClientEdit" tabindex="-1" aria-labelledby="modalClientEdit" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light btn-close-modal" data-bs-dismiss="modal">Отменить</button>
                    <button type="button" class="btn btn-add-light" id="btn-add-client-from-edit">Сохранить</button>
                </div>
            </div>
        </div>
    </div>
...
<!--                                            </script>-->
    ...
    <script>
        ...
        function setFieldsClassic(){
            ...
            $("#carrier_info-input").inputmask("8 (999) 999-99-99, код в АТИ *{3,10}, Имя: *{0,50}");
        ...
        $('.duplicate').on('click', function(){
            ...
            $('.form__body__client #marshrut-list').html($('.form__body__carrier #marshrut-list').html());
        ...
        $('.application_add').click(function (){
            ...
            $.ajax({
                url: '/application/ajax/add-application',
                method: 'POST',
        ...
        function setDriversSelectsOptions(){
            $('#driver_carrier').on('change', function (){
                console.log("driver_carrier");
                let driver_id_carrier = $(this).val();
                console.log(driver_id_carrier)
                $.ajax({
                    url: '/application/ajax/get-driver',
                    method: 'POST',
                    data: {id: driver_id_carrier},
                    success: function (driver_json){
                        $('.driver-info').show();
                        ...
                        if(driver_array['listCar'].length > 0){
                            ...
                            console.log(htmlOptionDriverCar);
                ...
                success: function (data_json){
                    ...
                    if (data['status'] === "Success"){
                     ...
                     <script>
                        ...
                        if(data['error']){
                            for(key in data['error']){
                                $('.form-control[name="carrier_' + key + '"]').addClass('error-validate');
                                if(key == 'address')
                                    $('.form-control[name="carrier_legal_' + key + '"]').addClass('error-validate');
