...
?>
    ...
    <style>
        ...
        .application-background-color.application-background-color-1{
            background-color: rgb(220 53 69)!important;
        }
        .application-background-color.application-background-color-2{
            background-color: #ffc107!important;
        }
        .application-background-color.application-background-color-3{
            background-color: #a3a3a3ff!important;
        }
        .application-background-color.application-background-color-4{
        ...
        <section class="analytics-applications__list mb-5">
            <div class="container-fluid p-2 mb-5" style="background-color: #f5f5f5">
                ...
                <div class="table-container">
                    ...
                    <button class="btn btn-success js-excel">Скачать в Excel</button>
                    <div class="d-flex justify-content-between mb-2 mt-2">
                        <div class="d-flex align-items-center">
                            <div class="square application-background-color application-background-color-1"></div> - Агрессия
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="square application-background-color application-background-color-2"></div>
                             - НП на АТИ
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="square application-background-color application-background-color-3"></div>
                             - СУД
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="square application-background-color application-background-color-4"></div>
                             - в принятии ожидают
                        </div>
                    </div>
                ...
                <div id="contextMenu" class="dropdown-menu" style="display: none; position: absolute; z-index: 9999;">
                   ...
                   <a class="dropdown-item" id="add-comment" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <div class="dropdown-item set-color-application" data-color="1">
                        Выделить заявку - Красный
                    </div>
                    <div class="dropdown-item set-color-application" data-color="2">
                        Выделить заявку - Желтый
                    </div>
                    <div class="dropdown-item set-color-application" data-color="3">
                        Выделить заявку - Серый
                    </div>
                    <div class="dropdown-item set-color-application" data-color="4">
                        Выделить заявку - Зеленый
                    </div>
    ...
    <script>
        $('.js-excel').click(function(){
            $.ajax({
                url: '/register-payment/ajax/save-excel',
                method: 'POST',
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    $.each(data, function(index, value){
                        $('.tr-application[data-id-app="' + value['id_application'] + '"').addClass('application-background-color application-background-color-' + value['color'] +'');
                    });
                }
            })
        }
        ...
        $('.tr-application').on('contextmenu',function (e){
            ...
            if($('.active-select').hasClass('application-background-color')){
                ...
                $('.set-color-application[data-color="1"]').text('Выделить заявку - Красный');
                $('.set-color-application[data-color="2"]').text('Выделить заявку - Желтый');
                $('.set-color-application[data-color="3"]').text('Выделить заявку - Серый');
                $('.set-color-application[data-color="4"]').text('Выделить заявку - Зеленый');
            }
